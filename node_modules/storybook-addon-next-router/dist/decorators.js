...
var WithNextRouter = function (Story, context) {
    var _a, _b;
    var _c = (_a = context.parameters.nextRouter) !== null && _a !== void 0 ? _a : {}, Provider = _c.Provider, parameters = tslib_1.__rest(_c, ["Provider"]);
    if (Provider === undefined)
        throw new Error('NextContext.Provider is undefined, please add it to parameters.nextRouter.Provider');
    router_1.default.router = tslib_1.__assign({ locale: (_b = context === null || context === void 0 ? void 0 : context.globals) === null || _b === void 0 ? void 0 : _b.locale, route: '/', pathname: '/', query: {}, asPath: '/', push: function () {
            var args = [];
    ...
    return ((0, jsx_runtime_1.jsx)(Provider, tslib_1.__assign({ value: router_1.default.router }, { children: (0, jsx_runtime_1.jsx)(Story, tslib_1.__assign({}, context)) })));
};
